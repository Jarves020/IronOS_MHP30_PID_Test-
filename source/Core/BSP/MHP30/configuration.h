...
#define PID_TIM_HZ             (16)                    // default 16
...
#define SLEW_LIMIT             200                      // Limit to 3.0 Watts per 64ms pid loop update rate slew rate; def. 50
#define ACCEL_MMA
#define ACCEL_LIS
#define ACCEL_SC7
#define ACCEL_MSA
...
#define TIP_THERMAL_MASS         10000 // Test with 20; TODO, needs refinement
