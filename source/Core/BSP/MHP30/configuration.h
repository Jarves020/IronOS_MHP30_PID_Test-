...
#define SLEW_LIMIT             150                      // Limit to 3.0 Watts per 64ms pid loop update rate slew rate; def. 50
#define ACCEL_MMA
#define ACCEL_LIS
#define ACCEL_SC7
#define ACCEL_MSA
...
#define TIP_THERMAL_MASS         6000 // Test with 20; TODO, needs refinement
